...
public class PieceWorkerEmployee extends Employee{
    ...
    public PieceWorkerEmployee(Name name, int empID){
        super(name, empID);
    }
    
    public PieceWorkerEmployee(Name name, Date startDate, Date endDate, int empID){
    ...
    public PieceWorkerEmployee(int totalPiecesFinished, double ratePerPiece, Name name, Date dateHired, Date dob, int id) {
