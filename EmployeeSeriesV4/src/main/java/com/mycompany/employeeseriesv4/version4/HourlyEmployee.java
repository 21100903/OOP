...
public class HourlyEmployee extends Employee{
    ...
    public HourlyEmployee(Name name, Date startDate, Date endDate, int empID){
    ...
    public HourlyEmployee(float totalHoursWorked, double ratePerHour, Name name, Date dateHired, Date dob, int id) {
