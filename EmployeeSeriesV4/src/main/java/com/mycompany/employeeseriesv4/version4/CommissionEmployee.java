...
public class CommissionEmployee extends Employee {
    ...
    public CommissionEmployee(Name name, int id) {
        super(name, id);
    }

    public CommissionEmployee(Name name, Date dateHired, Date dob, int id) {
        super(name, dateHired, dob, id);
    }

    public CommissionEmployee(double totalSales, Name name, Date dateHired, Date dob, int id) {
        super(name, dateHired, dob, id);
